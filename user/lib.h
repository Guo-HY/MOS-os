...
void _user_debug(const char *file, int line, const char *fmt, ...);
#define user_debug(...) _user_debug(__FILE__, __LINE__, __VA_ARGS__)
...
#define O_APPEND    0X0004		/* 追加 */	
#define O_ALONE		0x0008		/* 父子进程不再共享文件描述符的偏移指针*/
